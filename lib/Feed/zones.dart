      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              children: [
                Align(
                  ...
                  child: RoundedImageButton(
                    imagePath:
                        'assets/zones/business.png', // Replace with correct path
                ...
                Align(
                  ...
                  child: RoundedImageButton(
                    imagePath:
                        'assets/zones/blood.png', // Replace with correct path
                    onTap: () => Navigator.push(
                      context,
                ...
                Align(
                  ...
                  child: RoundedImageButton(
                    imagePath:
                        'assets/zones/pet.png', // Replace with correct path
                    onTap: () => Navigator.push(
                      context,
            ...
            const Padding(
              padding: EdgeInsets.only(left: 10.0),
              child: Text('Followed by your knots and buddies',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ),
            const SizedBox(height: 10),
            SizedBox(
