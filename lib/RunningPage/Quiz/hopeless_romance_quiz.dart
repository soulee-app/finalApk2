...
class _HopelessRomanceQuizState extends State<HopelessRomanceQuiz> {
  ...
  String getResult() {
    if (result1 >= result2 &&
        ...
        result1 >= result4 &&
        result1 >= result5) {
      return "Result : Hopeless Romantic\n"
          "Strengths: You're the traditional hopeless romantic. You believe in love and are willing to go to any lengths to protect it. Once you love someone, you're done. You wear your heart on your sleeve, always striving for a deep emotional connection. Passion drives you, and you're not afraid to commit fully.\n"
          "Areas to work on: Sometimes, you might get caught up in your dreams and struggle with the reality of relationships, making compromise a challenge.\n"
          "Key takeaways: Ground your passion: The way you love is beautiful; don't change it. Never change your personality for the world. But remember that real love often grows in the balance between fantasy and reality.";
    } else if (result2 >= result1 &&
        result2 >= result3 &&
        result2 >= result4 &&
        result2 >= result5) {
      return "Result : Ready & Steady\n"
          "Strengths: Steady and reliable, you're the rock in your relationships. You value open communication and strive to be supportive.\n"
          "Areas to work on: Being too calculated can hold you back from loving blindly, but that isn't a bad thing. Protecting your own emotions with a hint of maturity is an art not everyone can master.\n"
          "Key takeaways:\n"
          "Speak your truth: Your relationships will thrive even more when you share your thoughts and feelings with confidence. But remember to share your feelings without losing your personality and footing.";
    } else if (result3 >= result1 &&
        result3 >= result2 &&
        result3 >= result4 &&
        result3 >= result5) {
      return "Result : Sassy Spirit\n"
          "Strengths: Self-assured and comfortable in your own skin, you know your worth, which is absolutely everything. You value your personal space over anything and would rather be alone than be with someone who doesn't know your worth.\n"
          "Key takeaways:\n"
          "Sometimes, your strong personality can create distance, leaving your partner feeling a bit left out. Notice if you, the absolute prize, are dating them; they must be special as well.";
    } else if (result4 >= result1 &&
        result4 >= result2 &&
        result4 >= result3 &&
        result4 >= result5) {
      return "Result : The Casual Observer\n"
          "Strengths: Laid-back and easygoing, you enjoy life as it comes, rarely sweating the small stuff.\n"
          "Areas to work on: Sometimes, your relaxed approach may come across as indifference, especially when it comes to commitment.\n"
          "Key takeaways:\n"
          "Take the lead occasionally: Small gestures and intentional actions can strengthen your bond without forcing you out of your comfort zone.\n"
          "Express your needs: It's okay to want more; just be sure to communicate those desires when they arise.";
    } else {
      return "Result : The Introvert\n"
          "Strengths: Creative and comfortable in solitude, you're someone who enjoys your own world. Independence is key for you.\n"
          "Areas to work on: Emotional connection and intimacy can sometimes feel like foreign concepts, making it hard to fully engage with your partner.\n"
          "Key takeaways:\n"
          "Effort brings connection: Invest time in your relationship by being present and sharing your thoughts and feelings, even if it feels uncomfortable at first.\n"
          "Embrace new adventures: Pushing past your comfort zone will open up new experiences with your partner, enriching the relationship. Be yourself: If you're not comfortable with something, then don't do it, period.";
    }
  }
