...
import 'package:navbar/all_profile_screen/profile_screen/first_slide_two.dart';
import 'package:widget_mask/widget_mask.dart';

import '../../widgest/custom_text.dart';
import '../profile_screen/add_memory_page.dart';
import '../profile_screen/first_slide_screen.dart';
import '../profile_screen/postpage.dart';
import '../profile_screen/sceond_slid_screen.dart';
import '../profile_screen/widgets/custom_appbar.dart';
import '../profile_screen/widgets/custom_text_button.dart';

class LowCompitablityScreen extends StatefulWidget {
  const LowCompitablityScreen({super.key});

  @override
  State<LowCompitablityScreen> createState() => _LowCompitablityScreenState();
}

class _LowCompitablityScreenState extends State<LowCompitablityScreen> {
